...
[wkj,wji,wib,wba,error_r,ite] = train_ABIJK_net(data,eta,beta,layer,3,2,itermax,Lowerlimit);
...
for ix=-30:1:31
    for iy=-35:1:36
        ...
        oa=[ndx ndy ndx*ndy 1]';

        ok = FeedFoward_ABIJK(wba,wib,wji,wkj,oa,3,2,layer);
